...
namespace pragmatic_quant_model.Model
{
    ...
    {
        IProcessPathGenerator Build(IModel model, Market market, PaymentInfo probaMeasure, DateTime[] simulatedDates);
    }
    ...
    public abstract class ModelPathGenereratorFactory<TModel> : IModelPathGenereratorFactory where TModel : class, IModel
    {
        ...
        public IProcessPathGenerator Build(IModel model, Market market, PaymentInfo probaMeasure, DateTime[] simulatedDates)
        {
